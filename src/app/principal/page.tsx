...
const MODULES: PrincipalModule[] = [
  ...
  },
  {
    key: "students",
    title: "Students",
    description: "Browse the student directory, profiles, fees, and attendance.",
  ...
  },
  {
    key: "timetable",
    title: "Timetable",
    description: "Weekly class schedules, teacher allocation, and room booking.",
  ...
  },
  {
    ...
    description: "Faculty directory, departmental composition, and live availability.",
  ...
  },
  {
    key: "library",
    title: "Library",
    description: "Catalog, borrowings, returns, and reading-room operations.",
  ...
  },
  {
    key: "transport",
    title: "Transport",
    description: "Bus routes, live tracking, pickup schedules, and fleet maintenance.",
  ...
  },
  {
    key: "announcements",
    title: "Announcements",
    description: "Broadcast institution notices and principal circulars across channels.",
  ...
  },
  {
    ...
    description: "Cross-module performance overview, trends, and AI-flagged highlights.",
